...
//Author Vance Howald
public class PillarDecorationController : Placeable
{
    Camera mainCamera;
    ...
    public override GameObject cloneObj(GameObject model, Placeable data, RaycastHit hit)
    {
        ...
        newFlower.GetComponent<PillarDecorationController>().enabled = true;
...
//        newFlower.transform.Rotate(new Vector3(0, 90, 0));
        ...
        PillarDecorationController currentFlowerObj = newFlower.GetComponent <PillarDecorationController>();
