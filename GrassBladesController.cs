...
//Author Vance Howald
public class GrassBladesController : Placeable
{
    ...
    public override GameObject cloneObj(GameObject model, Placeable data, RaycastHit hit)
    {
        ...
        newFlower.GetComponent<GrassBladesController>().enabled = true;
        ...
        GrassBladesController currentFlowerObj = newFlower.GetComponent<GrassBladesController>();
